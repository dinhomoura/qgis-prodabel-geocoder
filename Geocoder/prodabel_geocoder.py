...
from prodabel_geocoder_dialog import GeocoderDialog
import os.path
...
class Geocoder:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Prodabel Geocoder')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'Geocoder')
        self.toolbar.setObjectName(u'Geocoder')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Geocoder/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Consulta endereços de Belo Horizonte'),
            callback=self.run,
